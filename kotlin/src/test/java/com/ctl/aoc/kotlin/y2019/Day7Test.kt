...
internal class Day7Test {
    ...
    internal fun runWithPhases() {
        assertThat(Day7.runWithPhases(intArrayOf(3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0), listOf(4, 3, 2, 1, 0)))
                .isEqualTo(43210)

        assertThat(Day7.runWithPhases(intArrayOf(3, 23, 3, 24, 1002, 24, 10, 24, 1002, 23, -1, 23,
                101, 5, 23, 23, 1, 24, 23, 23, 4, 23, 99, 0, 0), listOf(0, 1, 2, 3, 4)))
                .isEqualTo(54321)

        assertThat(Day7.runWithPhases(intArrayOf(3, 31, 3, 32, 1002, 32, 10, 32, 1001, 31, -2, 31, 1007, 31, 0, 33,
    ...
    internal fun testFeedbackLoop() {
        val ex1 = intArrayOf(3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
                27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5)
        val ex2 = intArrayOf(3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,
