...
private fun <T> valueInRange(value: T, min: T, max: T): Boolean
        where T : Number = value >= min && value <= max

fun <T> doRecsOverlap(a: Rectangle<T>, b: Rectangle<T>): Boolean
        where T : Number {
    val xOverlap = valueInRange(a.x, b.x, b.x + b.width - 1) || valueInRange(b.x, a.x, a.x + a.width - 1)
    val yOverlap = valueInRange(a.y, b.y, b.y + b.height - 1) || valueInRange(b.y, a.y, a.y + a.height - 1)
